...
//array of names of books of the bible
string books[] = {
	"Genesis",
	"Exodus",
	"Leviticus",
...
// REQUIRED: == comparison
bool Ref::operator==(const Ref r) { return (r.book == this->book && r.chap == this->chap && r.verse == this->verse); }
